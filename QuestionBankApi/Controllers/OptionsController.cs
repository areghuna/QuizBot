...
namespace QuestionBankApi.Controllers
{
    public class OptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OptionId,OptionText,isAnswer")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OptionId,OptionText,isAnswer")] Option option)
        {
            if (ModelState.IsValid)
            {
